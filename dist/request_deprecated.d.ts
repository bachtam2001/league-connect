 ...
 * proper type
 */
export declare class DEPRECATED_Response<T> extends FetchResponse {
...
export declare function DEPRECATED_request<T = any, R = any>(options: DEPRECATED_RequestOptions<T>, credentials?: Credentials): Promise<DEPRECATED_Response<R>>;
