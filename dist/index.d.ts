export { authenticate, AuthenticationOptions, Credentials, ClientNotFoundError, InvalidPlatformError } from './authentication';
...
export { createWebSocketConnection, ConnectionOptions, LeagueWebSocket, EventResponse, EventCallback } from './websocket';
